...
def render_opencode_install_md() -> str:
	...
	content = (
		"<!-- AUTO-GENERATED by index_lib/build_plugin_manifest.py. "
...
def render_opencode_js() -> str:
	...
	lines.append(" *")
	lines.append(
		" * AUTO-GENERATED by index_lib/build_plugin_manifest.py. Edit each skill's"
		" SKILL.md file and rerun; hand edits are overwritten."
	)
	lines.append(" */")
	lines.append("")
...
#============================================
def write_or_check_manifests(check: bool) -> int:
	...
	version = index_lib.frontmatter.to_manifest_semver(repository_version)
...
#============================================
def main() -> int:
	"""Run the plugin-manifest command."""
	args = parse_args()
	status = write_or_check_manifests(args.check)
	return status
