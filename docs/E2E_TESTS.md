...
- `tests/playwright/` (and optional `tests/playwright/e2e/` sub-grouping) - **browser-based E2E**: full Playwright walkthroughs and browser-driven tests. The deep dive lives in [../templates/typescript/docs/PLAYWRIGHT_USAGE.md](../templates/typescript/docs/PLAYWRIGHT_USAGE.md).
...
- `tests/playwright/` (with optional `tests/playwright/e2e/` subfolder) - browser-driven Playwright tests. See [../templates/typescript/docs/PLAYWRIGHT_USAGE.md](../templates/typescript/docs/PLAYWRIGHT_USAGE.md).
...
- For browser-driven Playwright runs, see [../templates/typescript/docs/PLAYWRIGHT_USAGE.md](../templates/typescript/docs/PLAYWRIGHT_USAGE.md).
...
- [../templates/typescript/docs/PLAYWRIGHT_USAGE.md](../templates/typescript/docs/PLAYWRIGHT_USAGE.md): browser-tier deep dive for Playwright tests under `tests/playwright/`.
