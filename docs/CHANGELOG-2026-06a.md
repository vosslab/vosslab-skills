...
- Synced vendored [run_web_server.sh](../skills/manage/html-game-parallel-builder/templates/run_web_server.sh)
...
- Added [PLAN_TEMPLATE_BLANK.md](../skills/plan/blueprint-plan-drafter/references/PLAN_TEMPLATE_BLANK.md):
...
- Renamed `references/PLAN_TEMPLATE.md` to
  [PLAN_TEMPLATE_EXAMPLE.md](../skills/plan/blueprint-plan-drafter/references/PLAN_TEMPLATE_EXAMPLE.md)
...
- Renamed 6 process skills and merged `delegate-manager-to-subagents/templates/` into a single `references/role-catalog.md`:
  ...
  - `execution-manager` -> `delegate-manager-to-subagents` (verb-first; "subagents" as keyword token 4 for searchability; templates folder collapsed into [role-catalog.md](../skills/manage/delegate-manager-to-subagents/references/role-catalog.md)).
