...
for historical context. Not indexed in [SKILLS_INDEX.md](../../SKILLS_INDEX.md)
...
| --- | --- | --- |
| `old-manager-review-existing-plan` | Severe internal inconsistency: divergent duplicate of `plan_quality_standard.md` (milestone vs phase vocabulary), broken cross-links to a missing `references/CAPACITY_AND_SIZING.md`, and `DEFINITIONS.md`/`NAMING_GUARDRAILS.md` at skill root but referenced as `references/X.md`. Already excluded from plugin manifest. | [audit-code-reviewer](../../../skills/quality/audit-code-reviewer/SKILL.md) for pre-merge multi-reviewer audit + [blueprint-plan-drafter](../../../skills/planning/blueprint-plan-drafter/SKILL.md) for forward-looking planning standard. |
| `old-orchestrate-next-milestone` | Skill body explicitly cross-referenced `delegate-manager-to-subagents` as its modern home; standalone-doer mode rarely applied. Already excluded from plugin manifest. | [delegate-manager-to-subagents](../../../skills/management/delegate-manager-to-subagents/SKILL.md) for manager-driven dispatch + [parallel-plan](../../../skills/management/parallel-plan/SKILL.md) for lane splitting. |

## Still active

[SKILL.md](../../../skills/quality/old-python-code-review/SKILL.md)
