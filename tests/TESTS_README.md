...
- Single browser test: `node tests/playwright/test_<name>.mjs` (see [../templates/typescript/docs/PLAYWRIGHT_USAGE.md](../templates/typescript/docs/PLAYWRIGHT_USAGE.md))
...
- [../templates/typescript/docs/PLAYWRIGHT_USAGE.md](../templates/typescript/docs/PLAYWRIGHT_USAGE.md) -- browser-driven test conventions
