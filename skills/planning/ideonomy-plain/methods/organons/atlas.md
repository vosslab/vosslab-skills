...
A bound collection of maps covering the same territory at different scales, themes, or projections. The atlas is the multi-perspective view.

## To atlas-ify an idea

1. **Pick N perspectives** through which to see the idea. Useful default perspectives:
   - Physical / material
   - Economic
   - Temporal / historical
   - Social / political
   - Personal / phenomenological
   - Mythic / narrative
   - Mechanistic / process
   - Information-flow
...
Atlases are the natural output of the **atlas-of-perspectives** recipe. They're also the right organon when the user's idea has stakeholders or framings that disagree, and you want to expand the idea by giving each frame its own page.
