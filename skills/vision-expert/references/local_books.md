...
Use this reference to choose between the local computer-vision book resources bundled with this skill.

## Preferred local resources

- `Learning_OpenCV.txt`
  Use for broad OpenCV coverage, feature detection and matching, custom detectors, and practical image-processing pipelines.
- `OpenCV_Cookbook.txt`
