...
- Reason: planning labels change; code identifiers must remain stable.

## Durable Naming In Code
- Use Stage / Pass / Step for gameplay pipeline or algorithm steps.
- Use Component / Module / Subsystem / Contract for durable boundaries and behavior surfaces.
- Prefer behavior-based test names over schedule-based names.

## Legacy Handling
- If a repository already has `phaseN_*` filenames, treat "phase" there as legacy meaning "stage".
