...
```bash
bash /path/to/vosslab-skills/skills/docs/screenshot-docs/scripts/install_playwright_capture.sh
```
...
node skills/docs/screenshot-docs/scripts/screenshot_web.mjs \
    http://localhost:8080/ \
