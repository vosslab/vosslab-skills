...
| Stage | Skill | Purpose |
| --- | --- | --- |
| Plan creation | planning-manager | Build plan from scratch |
| Plan execution (parallel) | parallel-plan | Lightweight parallelization for active work |
| Milestone execution | milestone-manager | Execute a milestone to closure with evidence |
| Plan audit | plan-review-manager | Verify code satisfies plan goals and gates |
